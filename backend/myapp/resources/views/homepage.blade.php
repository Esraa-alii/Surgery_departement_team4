...
<body>
  ...
  <div class="floating-box">
      <div class="arrow">
      <a href="#" title="Back to Top"><div class="fas fa-angle-up"></div></a>
      </div>
      <div class="label">Book appointment! <div class="right-button"></div></div>
      </div>
  ...
  <h2 id="spec" class="section-title" data-0-top="opacity:0;left:100px;" data-200-top="opacity:1;left:0px;" ><b>Surgical Specialties</b></h2>
...
<!-- latest news section================================================================= -->
  ...
  <div id="media" class="last-news">
    <div class="news-title" data-0-top="opacity:0;left:100px;" data-200-top="opacity:1;left:0px;"> <b>Our Latest News</b> </div>

      <div class="news-box">
        <div class="news-content">A</div>
        <div class="news-content1"><b>bout Conference</b></div>
        <div class="news-content2">Scientex Conference with incomparable hospitality and at the center for energy invites all the participants from across the world to attend our International Conference on Surgery and Anesthesia highlighting the following the theme "Pathbreaking Innovations in Surgery and Research”.</div>
    ...
    <div class="new-box-image">
        ...
        <div class="img-big-circle" data-center-center="opacity:1;left:0px;" data-0-bottom="opacity:0;left:-400px;"></div>
    </div>
...
<!--health hub swiper =================================================================== -->
  ...
  <div id="patient" class="health-hub">
    <div class="blog-card">
      <div class="health-title" data-0-top="opacity:0;left:100px;" data-200-top="opacity:1;left:0px;"><b> Health Hub</b> </div>
        ...
        <div class="inner-part">
          ...
          <div class="contentt contentt-1">
            ...
            <div class="text">Attempting to enhance your immune system's cells is extremely difficult since the immune system contains so many distinct types of cells that respond to germs in so many different ways.</div>
        ...
        <div class="inner-part">
          ...
          <div class="contentt contentt-2">
            ...
            <div class="text">Taking a medicine in a way or dose different than recommended; taking someone else's prescription, even if it's for a genuine medical reason like pain.</div>
            <button>Read more</button>
          </div>
        </div>
        ...
        <div class="inner-part">
          ...
          <div class="contentt contentt-3">
            ...
            <div class="text">We can reduce the risk of cardiovascular diseases through decrease the 3 white poisons consumption: Salt, Sugar, and Flour .</div>
             <button>Read more</button>
          </div>
        </div>
